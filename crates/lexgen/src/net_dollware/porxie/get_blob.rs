...
//
// Lexicon: net.dollware.porxie.getBlob
//
...
/// Response type for net.dollware.porxie.getBlob
pub struct GetBlobResponse;
impl jacquard_common::xrpc::XrpcResp for GetBlobResponse {
    const NSID: &'static str = "net.dollware.porxie.getBlob";
...
/// Endpoint type for net.dollware.porxie.getBlob
pub struct GetBlobRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetBlobRequest {
    const PATH: &'static str = "/xrpc/net.dollware.porxie.getBlob";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
